...
import kim.bifrost.rain.common.utils.BindView
...
abstract class BaseActivity(
    ...
    protected fun startActivity(clazz: Class<*>, handleIntent: Intent.() -> Unit = {}) {
        startActivity(Intent(this, clazz).also(handleIntent))
    }
}
